		...
		<div class="posts-default-content">
			...
			<div class="posts-default-info">
				<ul>
					...
					<li class="ico-eye"><i class="icon-eye-1"></i> <?php post_views('',''); ?></li>
					<li class="ico-like"><i class="icon-heart"></i> <?php if( get_post_meta($post->ID,'suxing_ding',true) ){ echo get_post_meta($post->ID,'suxing_ding',true); } else {echo '0';}?></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="posts-default-content">
			...
			<div class="posts-default-info">
				<ul>
					...
					<li class="ico-time"><i class="icon-clock-1"></i> <?php echo timeago( get_gmt_from_date(get_the_time('Y-m-d G:i:s')) )?></li>
					<li class="ico-eye"><i class="icon-eye-1"></i> <?php post_views('',''); ?></li>
					<?php if(suxingme('suxingme_post_like',true)) { ?><li class="ico-like"><i class="icon-heart"></i> <?php if( get_post_meta($post->ID,'suxing_ding',true) ){ echo get_post_meta($post->ID,'suxing_ding',true); } else {echo '0';}?></li><?php } ?>
				</ul>
			</div>
		</div>
	</div>
